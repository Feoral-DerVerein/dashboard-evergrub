...
const Market = () => {
  ...
  const categories = ["All Products", "Meat", "Poultry", "Seafood", "Dairy", "Dry Goods", "Beverages", "Prepared Meals", "Fruit & Veg", "Snacks & Confectionary"];
      ...
      <div className="container mx-auto p-6">
        ...
        <div className="bg-primary/10 p-4 rounded-lg mb-6">
          <div className="flex flex-wrap gap-4 text-sm">
            {categories.map(category => <span key={category} onClick={() => setSelectedCategory(category)} className={`cursor-pointer transition-colors ${selectedCategory === category ? "font-medium text-primary" : "text-muted-foreground hover:text-primary"}`}>
                {category}
              </span>)}
          </div>
        </div>
        ...
        <Tabs defaultValue="live-offers" className="w-full">
          <TabsList className="grid w-full grid-cols-5">
            <TabsTrigger value="live-offers">                                                  Negentropy Trade</TabsTrigger>
          ...
          <TabsContent value="live-offers" className="mt-6">
            ...
            <div className="space-y-6">
              {filteredOffers.map(offer => <div key={offer.id}>
