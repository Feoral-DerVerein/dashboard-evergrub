    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-md mx-auto bg-white min-h-screen">
        ...
        <main className="p-6 space-y-6">
          ...
          {/* Cover Photo */}
          <div className="relative h-40 bg-gray-100 rounded-lg flex items-center justify-center group">
            ...
            <Button size="icon" className="absolute bottom-4 right-4 rounded-full bg-blue-600 hover:bg-blue-700">
              <Plus className="h-4 w-4" />
            </Button>
          </div>
