...
const Notifications = () => {
  ...
  return <div className="min-h-screen bg-gray-50 pb-20">
      <div className="max-w-md mx-auto bg-white min-h-screen">
        ...
        <main className="px-6">
          {viewMode !== "products" && <p className="text-gray-500 mb-6">
              You have {filteredNotifications.length} {filteredNotifications.length === 1 ? "notification" : "notifications"}
            </p>}

          {renderContent()}

          {viewMode !== "products" && filteredNotifications.length > itemsPerPage && <div className="flex justify-center items-center space-x-2 my-8">
