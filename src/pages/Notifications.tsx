      ...
      <div className="max-w-md mx-auto bg-white min-h-screen">
        ...
        <main className="px-6">
          ...
          {loading ? <div className="space-y-6">
            ...
            return <div key={notification.id} className={`flex items-start space-x-4 p-3 rounded-lg ${!notification.is_read ? 'bg-blue-50' : ''}`}>
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex justify-between items-center mt-2">
                        ...
                        <div className="flex gap-2">
                          ...
                          {isWishlistItem && notification.product_id && <Button variant="outline" size="sm" className="h-8 text-xs bg-blue-50 text-blue-700 hover:bg-blue-100" onClick={() => notification.product_id && handleNotifyWishlistUsers(notification.product_id)}>
