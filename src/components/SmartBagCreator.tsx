...
const categories = [
  ...
  { value: "Cena Rápida", label: "🍝 Cena Rápida", emoji: "🍝" },
  { value: "Dulce/Postres", label: "🍰 Dulce/Postres", emoji: "🍰" },
  { value: "Lunch Office", label: "🥪 Lunch Office", emoji: "🥪" }
];
          ...
          <CardContent>
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
              <div>
                ...
                <input type="hidden" {...register("category", { required: "Selecciona una categoría" })} />
              </div>
              ...
              <div>
                ...
                <Input
                  id="name"
                  placeholder="Ej: Bolsa Inteligente Desayuno"
              ...
              <div>
                ...
                <Textarea
                  id="description"
                  placeholder="Describe qué pueden esperar los clientes..."
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    id="expiresAt"
                    type="datetime-local"
                    {...register("expiresAt", { required: "Fecha requerida" })}
                  />
                </div>
              </div>
                ...
                <div className="bg-white rounded-lg p-4 shadow-sm">
                  <div className="space-y-2">
                    ...
                    <div className="text-sm text-green-600">
                      {totalValue > 0 && (
                        <>Ahorro: {Math.round((1 - (watch("salePrice") || suggestedPrice) / totalValue) * 100)}%</>
                      )}
                    </div>
                  </div>
                </div>
