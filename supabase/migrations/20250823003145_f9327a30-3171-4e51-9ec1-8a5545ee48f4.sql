-- Update the get_ai_product_suggestions function to better integrate wishlist data
-- This will prioritize products that are in customer wishlists and provide more detailed demand information
